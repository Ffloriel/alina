  ...
  return (
    <Headless.MenuItems
      ...
      className={clsx(
        ...
        // Base styles
        'isolate w-max rounded-xl p-1.5',
...
export function DropdownItem({
  ...
  let classes = clsx(
    className,
    // Base styles
    'group cursor-default rounded-lg px-4 py-3 focus:outline-hidden sm:px-3.5 sm:py-2.5',
    // Text styles
    ...
    'col-span-full grid grid-cols-[auto_1fr_1.5rem_0.5rem_auto] items-start gap-y-1 supports-[grid-template-columns:subgrid]:grid-cols-subgrid',
    // Icons
...
export function DropdownHeader({ className, ...props }: React.ComponentPropsWithoutRef<'div'>) {
  return <div {...props} className={clsx(className, 'col-span-5 px-4 pt-3 pb-2 sm:px-3.5')} />
}
...
export function DropdownHeading({
  ...
  return (
    <Headless.MenuHeading
      ...
      className={clsx(
        className,
        'col-span-full grid grid-cols-[1fr_auto] gap-x-12 px-4 pt-3 pb-2 text-sm/5 font-medium text-zinc-500 sm:px-3.5 sm:text-xs/5 dark:text-zinc-400'
      )}
    />
  )
}
...
export function DropdownDivider({
  ...
  return (
    <Headless.MenuSeparator
      ...
      className={clsx(
        className,
        'col-span-full mx-4 my-1.5 h-px border-0 bg-zinc-950/5 sm:mx-3.5 dark:bg-white/10 forced-colors:bg-[CanvasText]'
      )}
    />
  )
}
...
export function DropdownDescription({
  ...
  return (
    <Headless.Description
      ...
      className={clsx(
        className,
        'col-span-2 col-start-2 row-start-2 text-sm/6 text-zinc-500 group-data-focus:text-white sm:text-xs/5 dark:text-zinc-400 forced-colors:group-data-focus:text-[HighlightText]'
      )}
    />
  )
}
