...
@Component({
  tag: 'alina-cookies-policy',
  styleUrl: 'alina-cookies-policy.css',
  shadow: true
})
export class AlinaCookiesPolicy {
  ...
  render() {
    return (
      <article>
        <figure class="hero">
          <picture>
            <img src={this.banner} alt="banner" />
            </picture>
        </figure>
        <h1>Cookies Policy</h1>
        <p>Last updated: {this.date}</p>
        <p>{this.companyName} (&quot;us&quot;, &quot;we&quot;, or &quot;our&quot;) uses cookies on the {this.websiteUrl} website and the {this.companyName} mobile application (the &quot;Service&quot;). By using the Service, you consent to the use of cookies.</p>
        ...
        <h2>How {this.companyName} uses cookies</h2>
        ...
        <p>If you&apos;d like to delete cookies or instruct your web browser to delete or refuse cookies, please visit the help pages of your web browser. As an European citizen, under GDPR, you have certain individual rights. You can learn more about these
        rights in the <a href="https://termsfeed.com/blog/gdpr/#Individual_Rights_Under_the_GDPR">GDPR Guide</a>.</p>
